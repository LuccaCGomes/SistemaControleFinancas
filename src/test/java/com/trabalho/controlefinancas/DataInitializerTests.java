...
public class DataInitializerTests {
    ...
    public void testRunShouldInitializeDataWhenRepositoryIsEmpty() throws Exception {
        ...
        assertThat(repository.findByName("Alimentação")).isNotNull();
        assertThat(repository.findByName("Transporte")).isNotNull();
        assertThat(repository.findByName("Saúde")).isNotNull();
        assertThat(repository.findByName("Salário")).isNotNull();
    }
